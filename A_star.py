...
&gt;A- Star in 8puzzle problem
f=g+h
g- depth that is how many times we move a
blank space
h- No. of missed placed tiles compared to final
state
then at each state we chose which ever is
less (f)
we need to minimise the value of h till its 0
At last g == f then done
